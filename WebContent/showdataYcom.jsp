...
<div class="container">
    ...
    <input type="button" value="copy" class="btn btn-xs btn-primary"
           onclick="selectElementContents( document.getElementById('byAgentNameYcom') );">
    <table id="byAgentNameYcom" style="margin-bottom: 80px;"
           class="table table-hover table-responsive table-bordered table-striped">
        <tr>
            <th colspan="11" class="titleofPlatform">Y.com</th>
        </tr>
        ...
        <%
            while (rsYcom.next()) {
                ...
                db_date = rsYcom.getString("TIME_STAMP");
        ...
        >
            ...
            <td><%=rsYcom.getDouble("SCRIPT_LATENCY")%>
            </td>
            <td><%=rsYcom.getDouble("SUCCESS")%>
            </td>
            <td><%=rsYcom.getDouble("AGENT_ERR")%>
            </td>
            <td><%=rsYcom.getDouble("SITE_ERR")%>
            </td>
            <td><%=rsYcom.getDouble("UAR_ERR")%>
            </td>
            <td><%=rsYcom.getDouble("INFRA_ERR")%>
            </td>
            <td><%=rsYcom.getDouble("NUM_OF_NAVIGATIONS")%>
            </td>
        </tr>
        <%
            }
